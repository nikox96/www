...
Product.list = function list(ccodda, ccoda, sven, xgrp, xprod, idord, callback) {
    ...
    var query = "select a.*, b.iqta, b.psco from portale.prodotti a left outer join (select ccodprod, iqta, psco from portale.righe_ordini where ccod = $6) b on a.ccod=b.ccodprod and a.ccod >= $1 AND a.ccod <= $2 AND a.xgrp ILIKE $3 AND a.xdesc ILIKE $4 AND a.sven ILIKE $5 ORDER BY a.ccod, b.iqta asc;";
    console.log(query);
    db.query(query
